import type { Plan, EnterprisePlan } from "@/types";
import { CheckIcon } from "lucide-react";
import ChoosePlanButtonForNonAuthenticated from "./ChoosePlanButtonForNonAuthenticated";

export default async function PricingPlanForNonAuthenticated({ plan }: { plan: Plan | EnterprisePlan}) {
  return (
    <div
      key={plan.name}
    ...
    >
      ...
      </ul>
      {
        plan.name === "Enterprise" ? (
          ...
          <ChoosePlanButtonForNonAuthenticated />
        )
      }
    </div>
  );
