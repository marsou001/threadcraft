...
import { generateContent, getUserPoints, updateUserPoints } from "@/services/users";
...
export default function GenerateContent() {
  ...
  async function handleGenerateContent(e: FormEvent) {
    ...
    try {
      ...
      const content = await generateContent(socialMedia, prompt);
    ...
    // Update user points
    const newUserPoints = userPoints - 5;
    try {
